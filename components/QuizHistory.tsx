...
import { Trophy, Clock, Target, TrendingUp, Calendar, RotateCw, ChevronRight, Loader2, Award, Zap, Brain, ArrowRight } from 'lucide-react';
...
const QuizHistory: React.FC<QuizHistoryProps> = ({ onRetry, onBack }) => {
    ...
    const getModeColor = (mode: string) => {
        switch (mode) {
            ...
            case 'deep-dive': return 'text-purple-400 bg-purple-500/10 ring-purple-500/20';
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-neutral-400 text-sm mt-1">Track your progress and performance</p>
                    </div>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <motion.div
                        ...
                        className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-white/5 rounded-2xl p-5 shadow-sm"
                    >
