          ...
          {goals.map((goal) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div
                  className={`absolute top-3 right-3 w-5 h-5 rounded-full border flex items-center justify-center transition-all flex-shrink-0 ${
                    goal.completed ? 'bg-green-500 border-green-500 text-black scale-110' : 'border-slate-600 group-hover:border-primary text-transparent'
                  }`}
                >
